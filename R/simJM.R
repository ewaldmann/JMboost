...
## beta: beta vector for the longitudinal subpredictor
## betals: beta vector for the shared subpredictor
...
## noninf: number of noninformative covariates for the longitudinal subpredictor
## noninfls: number of noninformative covariates for the longitudinal subpredictor
